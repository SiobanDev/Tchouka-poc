    ...
    <nav className="navbar navbar-menu" role="navigation">
      ...
      <div className="md-stepper-horizontal orange">
        ...
        <div className="md-step active done">
            ...
            <NavLink activeClassName="selected" to="/"><div className="md-step-title">Home</div></NavLink>
        ...
        <div className="md-step active">
            <div className="md-step-circle"><span>1</span></div>
            <NavLink activeClassName="selected" to="/rythme"><div className="md-step-title">Rythme</div></NavLink>
        ...
        <div className="md-step active">
            ...
            <NavLink activeClassName="selected" to="/percussions"><div className="md-step-title">Learn</div></NavLink>
        ...
        <div className="md-step active">
            ...
            <NavLink activeClassName="selected" to=""><div className="md-step-title">Percussion</div></NavLink>
